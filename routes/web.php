...
Route::middleware('auth')->group(function () {
    ...
    // Profile Routes
    Route::get('/admin/profile', [ProfileController::class, 'adminEdit'])->name('profile.admin_edit');
    Route::get('/employee/profile', [ProfileController::class, 'employeeEdit'])->name('profile.employee_edit');
