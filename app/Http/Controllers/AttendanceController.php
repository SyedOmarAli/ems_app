 ...
 public function updateStatus(Request $request)
{
    ...
    // if ($timeIn && $timeOut) {
    //     $workingMinutes = max(0, $timeIn->diffInMinutes($timeOut));
    // }
...
public function upload(Request $request)
{
   ...
   // ===================== MANUAL ATTENDANCE =====================
    ...
    // {
    //     $employees = Employee::all(); // show all employees
    ...
    //     return redirect()->route('attendance.show')->with('success', 'Attendance marked manually.');
    // }
